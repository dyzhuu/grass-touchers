<script lang="ts">
	...
	$: profile_url = gravatar.url(userEmail, { r: 'pg' });
...
<div class="flex justify-center items-center h-1/3">
	<Avatar
		class="ml-auto mr-auto absolute -translate-y-[6rem]"
		shadow="drop-shadow-md"
		width="w-40"
		border="border-4 border-tertiary-500"
		rounded="rounded-full"
		src={profile_url}
	/>
	<div
		class=" border-4 border-tertiary-500 flex justify-center items-end w-full h-full overflow-visible m-5 bg-gradient-to-tl bg-surface-400 rounded-3xl"
	>
		<h1
...
<div class="my-20">
	<div class="my-5 flex justify-center items-center">
		...
		<h1
			class="text-center text-6xl bg-gradient-to-b from-success-300 to-green-300 bg-clip-text text-transparent box-decoration-clone"
		>
			<b>0</b>
		</h1>
	</div>
